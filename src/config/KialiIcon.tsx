...
export const KialiIcon: { [name: string]: React.FunctionComponent<IconProps> } = {
  ...
  InProgress: (props: IconProps) => <InProgressIcon className={props.className} color={PFAlertColor.Info} />,
  ...
  PendingIcon: (props: IconProps) => <PendingIcon className={props.className} />,
