                        ...
                        <LocalTime
                          time={
                            this.props.experimentDetails && this.props.experimentDetails.experimentItem.createdAt
                              ? new Date(this.props.experimentDetails.experimentItem.createdAt / 1000000).toISOString()
                              : ''
                          }
                        />
                      </StackItem>
                        ...
                        <LocalTime
                          time={
                            this.props.experimentDetails && this.props.experimentDetails.experimentItem.startedAt
                              ? new Date(this.props.experimentDetails.experimentItem.startedAt / 1000000).toISOString()
                              : ''
                          }
                        />
                      </StackItem>
